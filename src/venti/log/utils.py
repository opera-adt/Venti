...
class log_context:
    ...
    def __enter__(self):
        ...
        self.logger.makeRecord = makeRecord_with_context
        return self.logger
    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                func_logger.log(level, f"Exiting function {func.__name__}", extra=exit_data)
                ...
                func_logger.error(f"Exception in function {func.__name__}", 
...
def setup_request_logging(logger: logging.Logger, 
    ...
    """
    Setup request logging for web applications.
...
def demo_logging():
    ...
    # Context logging
    with log_context(logger, service="demo_service", version="1.0.0"):
